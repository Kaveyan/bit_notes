...
export default function Menu() {
  ...
  return (
    <div className="w-80 bg-gray-800 text-white h-full p-6 flex flex-col">
      {/* Greeting Section */}
      <div className="mb-24 p-4 bg-gray-700 rounded-lg">
        <h2 className="text-3xl text-center font-semibold mb-2 font-mono">
        BITLEARN™ 
        </h2>
      </div>
      ...
      <p 
        ...
        className="mt-auto block text-xl mb-14 p-3 bg-red-500 rounded-lg hover:bg-red-600 cursor-pointer transition duration-200"
        aria-label="Logout"
      >
